...
#include <QOpenGLFunctions_3_3_Core> // Ensure this header is included
#include <cmath>
#include <algorithm>
...
namespace TyrexCAD {
   ...
   bool TyrexGridOverlayRenderer::initialize()
   {
       ...
       // Initialize OpenGL functions for OpenGL 3.3+
       ...
       glGenVertexArrays(1, &m_gridVAO); // Now this will work with QOpenGLFunctions_3_3_Core
   ...
   void TyrexGridOverlayRenderer::cleanup()
   {
       ...
       // Use QOpenGLFunctions_3_3_Core instead of QOpenGLFunctions
       QOpenGLFunctions_3_3_Core* f = QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_3_3_Core>();
       if (!f) {
           qCritical() << "Failed to obtain QOpenGLFunctions_3_3_Core";
           return;
       }

       if (m_gridVBO != 0) {
           f->glDeleteBuffers(1, &m_gridVBO);
           m_gridVBO = 0;
       }
       if (m_gridVAO != 0) {
           f->glDeleteVertexArrays(1, &m_gridVAO);
           m_gridVAO = 0;
       }
   ...
   void TyrexGridOverlayRenderer::setupVertexArrays()
   {
       ...
       f->glGenVertexArrays(1, &m_gridVAO); // Updated to use QOpenGLFunctions_3_3_Core
